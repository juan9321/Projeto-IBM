...
<body>
    <div class="wrapper">
        <h2 id="fonteL">Redefinir senha</h2>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post"> 
            ...
            <div class="form-group">
                <input id="bntE" type="submit" class="btn btn-primary" value="Redefinir">
                <a class="btn btn-link ml-2" href="welcome.php" id="cad">Cancelar</a>
            </div>
        </form>
    </div>    
</body>
